...
class DataService {
    ...
    constructor(archiver) {
        ...
        // data identifier.
        this.webServer.put(`/data/:${dataIdParam}`, (req,res) => this.putData(req,res));
        
        // Explicitly address a data object resource to delete
        this.webServer.delete(`/data/:${dataIdParam}`, (req,res) => this.deleteData(req,res));
    }
    ...
    postData(req,res) {
        if(this.verifyJsonRequest(req,res)) {
            ...
            this.archiver.create(req.body, (err, data) => this.response(err,data,res));
        }
    }
    ...
    putData(req,res) {
        if(this.verifyJsonRequest(req,res)) {
            ...
            this.archiver.insert(req.params[dataIdParam],req.body, (err, data) => this.response(err,data,res));
        }
    }
...
module.exports = (dataStore) => { return new DataService(dataStore) };
